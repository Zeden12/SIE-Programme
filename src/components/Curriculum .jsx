...
import { FaEdit, FaUserCheck, FaGraduationCap, FaBriefcase } from 'react-icons/fa';
  ...
  const phases = [
    {
      ...
      description: "Submit your application for your preferred program (Video, Audio, Development, or Design)",
      skills: ["Program Selection", "Application Review", "Admission Notification"],
    ...
    },
    {
      ...
      description: "Complete onboarding and begin your specialized learning path",
    ...
    },
    {
      ...
      description: "Develop professional-grade abilities through hands-on projects",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Your <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Career Pathway</span>
          </h2>
            ...
            {phases.map((phase, i) => (
              ...
              >
                <div className={`w-full md:w-5/12 p-8 rounded-2xl shadow-lg ${i % 2 ? 'md:mr-auto md:pr-16' : 'md:ml-auto md:pl-16'} bg-white mb-8 md:mb-16 relative z-10 border border-gray-200`}>
                  ...
                  <span className={`text-sm font-semibold ${phase.color.replace('bg-', 'text-')}`}>{phase.phase}</span>
                  <h3 className="text-2xl font-bold mt-1 mb-2 text-gray-800">{phase.title}</h3>
                  <p className="text-gray-600 mb-4">{phase.description}</p>
                  <ul className="space-y-2">
                    {phase.skills.map((skill, j) => (
                      <li key={j} className="flex items-start">
                        <span className={`w-2 h-2 rounded-full mt-2 mr-2 ${phase.color.replace('bg-', 'bg-')}`}></span>
        ...
        >
          <button className="bg-gradient-to-r from-blue-600 to-blue-800 text-white font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105 flex items-center mx-auto">
